            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">ثبت تغییرات</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-2 col-xl-3 col-lg-3 col-md-3">
                                    <label for="date" class="form-label">ورژن <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="version" id="date" form="form" value="{{ $softwareUpdate->version }}" required>
                                    @error('version')
                                    <div class="invalid-feedback text-danger d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-2 col-xl-3 col-lg-3 col-md-3">
                                    <label for="item" class="form-label">تغییرات <span class="text-muted">(موردی)</span> <span class="text-danger">*</span></label>
                            ...
                            <form action="{{ route('software-update.update', $softwareUpdate->id) }}" method="post" id="form">
                                @csrf
                                @method('put')
