                        ...
                        <div class="card-body">
                            <div class="row">
                                    <div class="mb-2 col-xl-3 col-lg-3 col-md-3">
                                        <label for="version" class="form-label">ورژن <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="version" form="form" required>
                                        @error('version')
                            ...
                            <form action="{{ route('software-update.store') }}" method="post" id="form">
                                @csrf
