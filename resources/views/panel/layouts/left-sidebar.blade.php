        ...
        <div id="sidebar-menu">
            <ul id="side-menu">
                    ...
                    <li class="{{ $active_side ? 'menuitem-active' : '' }}">
                        ...
                        <div class="collapse {{ $active_side ? 'show' : '' }}" id="orders">
                            <ul class="nav-second-level">
                                ...
                                @endcan
                                @can('costs-list')
                                    @php $active_item = active_sidebar(['costs','costs/create','costs/{costs}/edit']); @endphp
                                    <li class="{{ $active_item ? 'menuitem-active' : '' }}">
                                        <a href="{{ route('costs.index') }}" {{ $active_item ? 'active' : '' }}>
                                            بهای تمام شده
                                        </a>
                                    </li>
                                @endcan
                                @can('invoices-list')
                                    ...
                                    <li class="{{ $active_item ? 'menuitem-active' : '' }}">
                                        <a href="{{ route('invoices.index') }}" {{ $active_item ? 'active' : '' }}>پیش
                                            فاکتور ها</a>
                                    </li>
                                @endcan
                                @can('buy-orders-list')
                        ...
                        @can('transfer-list')
                            <div class="collapse {{ $active_side ? 'show' : '' }}" id="packets">
                                <ul class="nav-second-level">
                                    ...
                                    <li class="{{ $active_item ? 'menuitem-active' : '' }}">
                                        <a href="{{ route('transfers.index') }}" {{ $active_item ? 'active' : '' }}>مشخصات
                                            ارسال بسته </a>
                                    </li>
                                </ul>
                            </div>
                ...
                @can('employee-request-list')
                    @php $active_side = active_sidebar(['employee-requests','employee-requests/create','employee-requests/{employee_request}','employee-requests/{employee_request}/edit','employee-requests/{employee_request}/action']); @endphp
                    <li class="{{ $active_side ? 'menuitem-active' : '' }}">
