            ...
            <form action="{{ route('software-updates.update', $softwareUpdate->id) }}" method="post">
                ...
                <div class="form-row">
                    <div class="col-xl-3 col-lg-3 col-md-3 mb-3">
                        ...
                        <input type="text" name="version_number" class="form-control" id="version_number"
                               value="{{ $softwareUpdate->version }}" placeholder="1.0.0">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 mb-3">
                        ...
                        <input type="text" name="release_date" class="form-control date-picker-shamsi-list"
                               id="release_date" value="{{ verta($softwareUpdate->release_date)->format('Y/m/d') }}">
                        @error('release_date')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 mb-3">
                        ...
                        <input type="text" name="description" class="form-control tagsinput" id="description"
                               value="{{ $softwareUpdate->description }}">
                        @error('description')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
