...
<div style="border: 2px solid black">
    <div style="font-size: 20px;width: 100%; margin-bottom: 20px">
        <table>
            <tr>
                ...
                <td>
                    <span
                        style="font-size: 25px; margin-right: 25px !important;font-weight: bold">مجوز خروج از انبار</span>
                </td>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="width: 30%">شناسه خروج : {{$exitRemittance->code}}</td>
        </tr>
        <tr>
...
<div class="col-12 mb-3">
    <div class="overflow-x-auto">
        ...
        <br>
        <table class="text-center table" style="width: 50%;">
            <thead>
            <tr class="title-sec">
                <th>ردیف</th>
            ...
            <tbody>
            @foreach(json_decode($exitRemittance->tracking_codes) as $item)
                <tr>
                    <td>{{ $loop->index + 1 }}</td>
                    <td>{{ $item->code ?? '-' }}</td>
                    <td>{{ \App\Models\Product::whereId($item->product_id)->first()->title ?? '-' }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
